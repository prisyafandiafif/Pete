...
//			float end_m_start = _DistanceParams.y - _DistanceParams.x;
//			float start_m_near = _DistanceParams.x - _ProjectionParams.y;
//
//			float fogatten = saturate( _DistanceParams.z * ((depth * (far_m_near)) - (start_m_near))/end_m_start);
